...
export const postSchoolDOUpdateChecklist = async (payload) => {
  // Payload structure: { "tempPayrollId": "string", "checkListIds": "string" }
  const response = await axios.post(
    `${API_BASE}/Do Controller/update-checklists`,
    payload
  );
  return response.data;
};