...
import SalaryLeftInfoConatiner from "../../../../containers/Employee_containers/acoordian-container/SalaryLeftInfoConatiner";

const SalaryDetailsLeftInfo = ({ employeeId }) => {
    return (
        <div className={styles.whole_medical_container}>
            ...
            <SalaryLeftInfoConatiner employeeId={employeeId} />
        </div>
    );
};
