...
import FamilyInfo from "../../../../containers/Employee_containers/FamilyAddressInfoMainContainer/FAmilyAddressInfoContainer";
import EmployeeQualificationDetailsContainer from "../../../../containers/Employee_containers/EmployeeQualificationDetails/EmployeeQualificationDetailsContainer";
import EmployeeDocumentsContainer from "../../../../components/Employee_components/EmployeeOverViewScreens/EmpDocuments/EmpDocuments";
import BankDetailsContainer from "../../../../containers/Employee_containers/BankDetailsContainer/BankDetailsConatiner";
import AgreementsDetails from "../../../../containers/Employee_containers/AgreementsConatiner/AgreementsDetailsContainer";
import SalaryDetailsContainer from "../../../../containers/Employee_containers/SalaryDetailsContainer/SalaryDetailsContainer";
      ...
      */}
      ...
      <div className={Styles.tabContent}>
        <Routes>
          ...
          <Route path="family-info" element={<FamilyInfo employeeId={employeeId} />} />
          <Route path="qualificationDetails/*" element={<EmployeeQualificationDetailsContainer employeeId={employeeId} />} />
          <Route path="documents/*" element={<EmployeeDocumentsContainer employeeId={employeeId} />} />
          <Route path="agreements" element={<AgreementsDetails employeeId={employeeId} />} />
          <Route path="bank-details" element={<BankDetailsContainer employeeId={employeeId} />} />
          <Route path="salary-info" element={<SalaryDetailsContainer employeeId={employeeId} />} />
        </Routes>
      </div>
    </div>
  );
