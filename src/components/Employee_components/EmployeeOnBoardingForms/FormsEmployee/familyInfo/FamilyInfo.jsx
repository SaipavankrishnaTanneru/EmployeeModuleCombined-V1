...
// API & Hooks
import { useEmployeeFormQueries } from "../../../../../queries/Employee_queries/onBoardingForms/dropDownApi/useEmployeeFormData";
import { useFamilyInfoFormik } from "../../../../../hooks/Employee_hooks/useFamilyInfoFormik";

// Assets & Widgets
import { ReactComponent as UploadIcon } from "../../../../../assets/Employee_asserts/Qualification/Upload.svg";
import BorderIcon from '../../../../../assets/Employee_asserts/Qualification/border.svg';
                      ...
                      <div className={styles.sectionBlock}>
                        ...
                        <div className={styles.row}>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', marginTop: '15px' }}>
                            ...
                            <GenderSelection
                              name={`${fieldName}.genderId`}
                              values={values}
                              setFieldValue={setFieldValue}
                              setFieldTouched={formik.setFieldTouched} // Using formik.setFieldTouched as it wasn't destructured
                              touched={touched}
                              errors={errors}
