...
import bellIcon from "../../../../assets/Employee_asserts/sidebaricons/alert_bellicon.svg";
import leftarrow_icon from "../../../../assets/Employee_asserts/sidebaricons/leftarrow_icon.svg";
import rightarrow_icon from "../../../../assets/Employee_asserts/sidebaricons/rightarrow_icon.svg";
...
const SideBarAlert = () => {
  ...
  return (
    <div className={styles.alert_box}>
      ...
      <div
        key={animKey}
        className={`${styles.swiper_part} ${direction === "next" ? styles.slideInRight : styles.slideInLeft
          }`}
      >
