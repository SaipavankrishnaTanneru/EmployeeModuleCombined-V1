...
// import { postSalaryInfo } from "../../queries/Employee_queries/onBoardingForms/postApi/useSalaryQueries";
...
// "five lakh per annum" → "Five Lakh Per Annum"
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const apiPayload = {
        ...
        // ✅ Title Case normalization (ONLY field needed here)
        ctcWords: toTitleCase(values.ctcWords),
        ...
        pfNo: values.isPfEligible ? values.pfNo : null,
        pfJoinDate: values.isPfEligible
          ? formatDate(values.pfJoinDate)
          : null,
        uanNo: values.isPfEligible ? Number(values.uanNo) : null,
        esiNo: values.isEsiEligible ? Number(values.esiNo) : null,
